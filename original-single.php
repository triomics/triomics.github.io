                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            <ul class="widget-list">
                                <li>
                                    <div class="light-gray-text border-bottom padding-five no-padding-lr no-padding-top xs-padding-three xs-no-padding-lr xs-no-padding-top"><a href="blog-details.html" class="display-block alt-font">Standard Post with Gallery</a>Saturday - June 15, 2013 at 12:04 pm</div>
                                </li>
                                <li>
                                    <div class="light-gray-text border-bottom padding-five no-padding-lr xs-padding-three xs-no-padding-lr"><a href="blog-details.html" class="display-block alt-font">Standard post with preview Video</a>Saturday - June 20, 2013 at 07:11 pm</div>
                                </li>
                                <li>
                                    <div class="light-gray-text border-bottom padding-five no-padding-lr xs-padding-three xs-no-padding-lr"><a href="blog-details.html" class="display-block alt-font">Standard post with preview Picture</a>Saturday - June 25, 2013 at 05:12 pm</div>
                                </li>
                                <li>
                                    <div class="light-gray-text padding-five no-padding-lr no-padding-bottom xs-padding-three xs-no-padding-lr"><a href="blog-details.html" class="display-block alt-font">Standard Post with Gallery</a>Saturday - June 15, 2013 at 09:14 am</div>
                                </li>
                            </ul>
                        </div>
                    </div>
