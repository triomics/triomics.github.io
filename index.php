                    ...
                    <div class="col-md-8 col-sm-8 blog-listing">
                        ...
                        <article>
                            ...
                            <div class="col-md-10 col-sm-10 post-details no-padding-right margin-twenty-nine no-margin-lr no-margin-top xs-no-padding-left xs-margin-twenty-three xs-no-margin-lr xs-no-margin-top">
                                ...
                                <a href="blog-details.html"><img src="http://placehold.it/800x549" alt=""/></a>
                        ...
                        <article>
                            ...
                            <div class="col-md-10 col-sm-10 post-details no-padding-right margin-twenty-nine no-margin-lr no-margin-top xs-no-padding-left xs-margin-twenty-three xs-no-margin-lr xs-no-margin-top">
                                <span class="alt-font display-block title-small xs-text-extra-large sm-text-medium margin-six no-margin-lr no-margin-top xs-text-center"><a href="blog-details.html">This is a standard post with thumbs gallery</a></span>
                        ...
                        <article>
                            ...
                            <div class="col-md-10 col-sm-10 post-details no-padding-right margin-twenty-nine no-margin-lr no-margin-top xs-margin-twenty-three xs-no-margin-lr xs-no-margin-top">
                                <span class="alt-font display-block title-small xs-text-extra-large sm-text-medium margin-six no-margin-lr no-margin-top xs-text-center"><a href="blog-details.html">This is a standard post with an embedded video</a></span>
                        ...
                        <article>
                            ...
                            <div class="col-md-10 col-sm-10 post-details no-padding-right xs-no-padding-left xs-margin-twenty-three xs-no-margin-lr xs-no-margin-top">
                                <span class="alt-font display-block title-small xs-text-extra-large sm-text-medium margin-six no-margin-lr no-margin-top xs-text-center"><a href="blog-details.html">This is a standard post with a HTML5 video</a></span>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <ul class=" widget-posts">
                                    ...
                                    <li><a href="blog-details.html" class="display-block alt-font">Standard post with preview Video</a>Saturday - June 20, 2013 at 07:11 pm</li>
                                    <li><a href="blog-details.html" class="display-block alt-font">Standard post with preview Picture</a>Saturday - June 25, 2013 at 05:12 pm</li>
                                    <li><a href="blog-details.html" class="display-block alt-font">Standard Post with Gallery</a>Saturday - June 15, 2013 at 09:14 am</li>
                                </ul>
                            </div>
                        </div>
                        <!-- end widget  -->
