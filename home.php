...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/favicon.ico" type="image/x-icon">
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon//apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/favicon-16x16.png">
    <link rel="manifest" href="<?php echo get_template_directory_uri(); ?>/<?php echo get_template_directory_uri(); ?>/images/favicon/manifest.json">
    <!-- animation -->
  ...
  <body style="background:url('<?php echo get_template_directory_uri(); ?>/images/image1.jpg') top #1e2126 no-repeat; background-size: 100%">
    <!-- navigation -->
      ...
      <div class="container navigation-menu">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-2 pull-right header-right text-right sm-display-none">
            <span class="text-uppercase white-text text-small md-display-none">Need Our Services? &nbsp;&nbsp;</span>
            <a class="btn-small-white btn btn-very-small no-margin inner-link" href="#contact">Let's do it!</a>
          </div>
        </div>
      </div>
    </nav>
      ...
      <div class="owl-slider-full owl-carousel owl-theme light-pagination dark-pagination-without-next-prev-arrow main-slider">
        ...
        <div class="item owl-bg-img">
          <div class="container position-relative">
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6 col-sm-6 no-padding travel-slider cover-background" style="background-image:url('https://d13yacurqjgara.cloudfront.net/users/943550/screenshots/2392569/uppp.gif'); background-size: 80% !important; background-color: #fff;"></div>
                <div class="col-md-6 col-sm-6 no-padding travel-slider cover-background" style="background-color: #fd7c5a;">
                  <!-- slider text -->
                  <div class="slider-typography text-left padding-twenty-seven xs-padding-thirteen">
                    <div class="slider-text-middle-main">
                      <div class="slider-text-middle slider-typography-option2 xs-display-block">
                        <span class="white-text font-weight-800 letter-spacing-3 alt-font text-uppercase">SEO Optimization</span><br>
                        <div class="bg-white separator-line-extra-thick no-margin-lr margin-twenty-two xs-margin-thirteen xs-no-margin-lr xs-width-20"></div>
                        <p class="white-text text-uppercase letter-spacing-2 alt-font width-90 xs-text-small">Мы обеспечим рост позиций Вашего сайта до топ-10 в течении 3-х месяцев*. Мы нацелены на результат. Если мы не справимся за это время, мы будем работать над этим беcплатно или вернем Вам деньги. Это инвестиции без риска Вашему бизнесу.</p>
                        <a class="highlight-button-transparent-border btn btn-medium margin-thirteen no-margin-lr no-margin-bottom inner-link" href="#packages">BE THE FIRST</a>
                      </div>
                    </div>
                  </div>
                  <!-- end slider text -->
        ...
        <div class="item owl-bg-img">
          <div class="container position-relative">
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6 col-sm-6 no-padding travel-slider cover-background" style="background-image:url('https://d13yacurqjgara.cloudfront.net/users/622/screenshots/405968/cddrblr.gif'); background-size: 70% !important; background-color: #412b4e;"></div>
                <div class="col-md-6 col-sm-6 no-padding travel-slider cover-background" style="background-color: #52e7bd;">
                  <!-- slider text -->
                  <div class="slider-typography text-left padding-twenty-seven xs-padding-thirteen">
                    <div class="slider-text-middle-main">
                      <div class="slider-text-middle slider-typography-option2 xs-display-block">
                        <span class="white-text font-weight-800 letter-spacing-3 alt-font text-uppercase">Web design</span><br>
                        <div class="bg-white separator-line-extra-thick no-margin-lr margin-twenty-two xs-margin-thirteen xs-no-margin-lr xs-width-20"></div>
                        <p class="white-text text-uppercase letter-spacing-2 alt-font width-90 xs-text-small">Дизайн - это один из самых важных елементов в вебе. Избалованные, требовательные и ленивые пользователи задают нам тренд в работе. Мы постоянно проводим опросы, и нарабатываем опыт, чтобы построить дизайн Вашего сайта дружественным к пользователю и обязательно адаптивным.</p>
                        <a class="highlight-button-transparent-border btn btn-medium margin-thirteen no-margin-lr no-margin-bottom inner-link" href="#packages">MAKE SOMETHING BEAUTIFUL</a>
                      </div>
                    </div>
                  </div>
                  <!-- end slider text -->
    ...
    <section id="about" class="wow fadeIn no-padding-bottom">
      <div class="container">
        <!-- section title -->
        <div class="row">
          <div class="col-md-12 col-sm-12 text-center">
            <span class="alt-font text-uppercase title-extra-large deep-orange-text letter-spacing-1">About us</span>
            <span class="text-large letter-spacing-1 margin-one display-block text-uppercase light-gray-text alt-font">What are you in the Mood for?</span>
          </div>
        </div>
        <!-- end section title -->
        <div class="row margin-thirteen no-margin-lr no-margin-bottom">
          ...
          <div class="col-md-5 col-sm-12">
            <span class="text-extra-large margin-eleven no-margin-lr no-margin-top display-inline-block alt-font white-text xs-margin-eleven xs-no-margin-lr xs-no-margin-top">We've been crafting beautiful websites, launching stunning brands and making clients happy for years.</span>
            ...
            <a class="highlight-button-white-border btn btn-medium button margin-ten no-margin-lr inner-link" href="#contact">Order now</a>
          </div>
          <!-- end text -->
          <!-- features box -->
          <div class="col-md-6 col-sm-12 col-md-offset-1 sm-padding-five sm-no-padding-lr sm-no-padding-bottom xs-margin-eleven xs-no-margin-lr xs-no-margin-bottom">
            ...
            <div class="col-md-6 col-sm-6 xs-margin-nineteen xs-no-margin-lr xs-no-margin-top">
              <i class="deep-orange-text icon-flag icon-medium margin-nine no-margin-lr no-margin-top xs-margin-three xs-no-margin-lr xs-no-margin-top"></i>
              <span class="text-medium font-weight-600 letter-spacing-2 text-uppercase white-text margin-five no-margin-lr no-margin-top display-block alt-font xs-margin-five xs-no-margin-lr xs-no-margin-top">We're Creative</span>
              <p class="text-medium width-90 xs-width-100">Lorem Ipsum is simply dummy text of the printing and type setting industry.</p>
            </div>
            <!-- end features box -->
            <!-- features box -->
            <div class="col-md-6 col-sm-6 xs-margin-nineteen xs-no-margin-lr xs-no-margin-top">
              <i class="deep-orange-text icon-clock icon-medium margin-nine no-margin-lr no-margin-top xs-margin-three xs-no-margin-lr xs-no-margin-top"></i>
              <span class="text-medium font-weight-600 letter-spacing-2 text-uppercase white-text margin-five no-margin-lr no-margin-top display-block alt-font xs-margin-five xs-no-margin-lr xs-no-margin-top">We're Punctual</span>
              <p class="text-medium width-90 xs-width-100">Lorem Ipsum is simply dummy text of the printing and type setting industry.</p>
            </div>
            <!-- end features box -->
            <!-- features box -->
            <div class="col-md-6 col-sm-6 margin-seven no-margin-lr no-margin-bottom xs-margin-nineteen xs-no-margin-lr xs-no-margin-top">
              <i class="deep-orange-text icon-heart icon-medium margin-nine no-margin-lr no-margin-top xs-margin-three xs-no-margin-lr xs-no-margin-top"></i>
              <span class="text-medium font-weight-600 letter-spacing-2 text-uppercase white-text margin-five no-margin-lr no-margin-top display-block alt-font xs-margin-five xs-no-margin-lr xs-no-margin-top">We're responsible</span>
              <p class="text-medium width-90 xs-width-100">Lorem Ipsum is simply dummy text of the printing and type setting industry.</p>
            </div>
            <!-- end features box -->
            <!-- features box -->
            <div class="col-md-6 col-sm-6 margin-seven no-margin-lr no-margin-bottom ">
              <i class="deep-orange-text icon-chat icon-medium margin-nine no-margin-lr no-margin-top "></i>
              <span class="text-medium font-weight-600 letter-spacing-2 text-uppercase white-text margin-five no-margin-lr no-margin-top display-block alt-font xs-margin-five xs-no-margin-lr xs-no-margin-top">We're Friendly</span>
              <p class="text-medium width-90 xs-width-100">Lorem Ipsum is simply dummy text of the printing and type setting industry.</p>
            </div>
            <!-- end features box -->
          </div>
    ...
    <!-- about section -->
    <section id="services" class="wow fadeIn no-padding-bottom">
      <div class="container-fluid">
        <!-- section title -->
        <div class="row">
          <div class="col-md-12 col-sm-12 text-center">
            <span class="alt-font text-uppercase title-extra-large deep-orange-text letter-spacing-1">our Services</span>
        ...
        <div class="row" style="margin-top: 8%;">
          <div class="col-lg-6 col-md-12 col-sm-12 parallax2 parallax-fix service xs-display-none">
            <img class="parallax-background-img" src="<?php echo get_template_directory_uri(); ?>/images/work-harder2.jpg" alt="" />
          </div>
          <!-- features box main-->
                        ...
                        <div class="container">
                          <div class="row">
                            <div class="col-md-5 col-sm-10 text-center center-col cursor-default">
                              <span class="title-small letter-spacing-2 text-uppercase alt-font white-text margin-ten no-margin-lr no-margin-top display-block">Project Description</span>
    ...
    <section class="wow fadeIn bg-deep-orange work-with-us">
      <div class="container">
        <div class="row">
          <div class="col-md-12 col-sm-12 text-center">
    ...
    <section id="special-offer" class="wow fadeIn fix-background fix-background-webkit" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/arc_full.jpg');">
      ...
      <div class="container position-relative">
        <div class="row">
          <div class="col-md-12 col-sm-12 text-center">
            ...
            <span class="text-large letter-spacing-1 margin-one display-block text-uppercase light-gray-text alt-font">Check out our best offers</span>
          </div>
        </div>
          ...
          <article class="col-md-6 col-sm-6 col-xs-12 margin-four no-margin-lr no-margin-top">
            <div class="col-md-12 col-sm-12 col-xs-12 no-padding bg-white">
              <div class="col-md-6 col-sm-6 col-xs-6 no-padding post-thumbnail overflow-hidden">
                <a href="#"><img src="http://placehold.it/850x850" alt=""/></a>
              </div>
              <div class="col-md-6 col-sm-6 col-xs-6 no-padding post-details-arrow">
                <div class="post-details">
                  ...
                  <div class="travel-special-off bg-deep-orange position-absolute alt-font black-text sm-text-extra-small">50% OFF</div>
                </div>
              </div>
            </div>
          </article>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 no-padding bg-white">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6 no-padding post-details-arrow">
                <div class="post-details">
                  ...
                  <span class="text-medium text-uppercase letter-spacing-2 alt-font light-gray-text sm-text-extra-small">8 Days / $350</span>
                  <div class="separator-line-thick bg-dark-blue margin-fifteen no-margin-bottom margin-lr-auto"></div>
                  <div class="travel-special-off bg-deep-orange position-absolute alt-font black-text sm-text-extra-small">30% OFF</div>
                </div>
              </div>
            </div>
          </article>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 no-padding bg-white">
              ...
              <div class="col-md-6 col-sm-6 col-xs-6 no-padding post-details-arrow">
                <div class="post-details">
                  ...
                  <span class="text-medium text-uppercase letter-spacing-2 alt-font light-gray-text sm-text-extra-small">8 Days / $350</span>
                  <div class="separator-line-thick bg-dark-blue margin-fifteen no-margin-bottom margin-lr-auto"></div>
                  <div class="travel-special-off bg-deep-orange position-absolute alt-font black-text sm-text-extra-small">25% OFF</div>
                </div>
              </div>
            </div>
          </article>
          ...
          <div class="blog-slider owl-carousel owl-theme light-pagination">
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-thumbnail overflow-hidden position-relative bg-dark-blue">
                  <a href="blog-details.html"><img src="http://placehold.it/800x520" alt=""/></a>
                  <span class="post-date text-small text-uppercase letter-spacing-2 alt-font light-gray-text position-absolute bg-dark-blue">25 June 2015</span>
                </div>
                <!-- end blog image -->
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large deep-orange-text md-title-large alt-font margin-one-half no-margin-lr display-block sm-display-none">01.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">Explore the Pacific Northwest</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Colin Powell</a></span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">02.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">The Fearful Adventurer</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Melanie Lang</a></span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-thumbnail overflow-hidden position-relative bg-dark-blue">
                  <a href="blog-details.html"><img src="http://placehold.it/800x520" alt=""/></a>
                  <span class="post-date text-small text-uppercase letter-spacing-2 alt-font light-gray-text position-absolute bg-dark-blue">23 June 2015</span>
                </div>
                <!-- end blog image -->
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">03.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">The Imperfect Adventures</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Adrian Taylor</a></span>
                  </div>
                </div>
              </div>
            </article>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-thumbnail overflow-hidden position-relative bg-dark-blue">
                  <a href="blog-details.html"><img src="http://placehold.it/800x520" alt=""/></a>
                  <span class="post-date text-small text-uppercase letter-spacing-2 alt-font light-gray-text position-absolute bg-dark-blue">21 June 2015</span>
                </div>
                <!-- end blog image -->
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">04.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">Travel and the Art of Losing</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Melanie Lang</a></span>
                  </div>
                </div>
              </div>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-thumbnail overflow-hidden position-relative bg-dark-blue">
                  <a href="blog-details.html"><img src="http://placehold.it/800x520" alt=""/></a>
                  <span class="post-date text-small text-uppercase letter-spacing-2 alt-font light-gray-text position-absolute bg-dark-blue">20 June 2015</span>
                </div>
                <!-- end blog image -->
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">05.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">Top golf destinations for Day</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Adrian Taylor</a></span>
                  </div>
                </div>
              </div>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-thumbnail overflow-hidden position-relative bg-dark-blue">
                  <a href="blog-details.html"><img src="http://placehold.it/800x520" alt=""/></a>
                  <span class="post-date text-small text-uppercase letter-spacing-2 alt-font light-gray-text position-absolute bg-dark-blue">19 June 2015</span>
                </div>
                <!-- end blog image -->
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">06.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">Miami Beach Vacation Rentals</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Colin Powell</a></span>
                  </div>
                </div>
              </div>
            ...
            <article class="item col-md-12 no-padding">
              <div class="col-md-12 col-sm-12">
                ...
                <div class="post-details display-inline-block text-left">
                  <div class="col-md-2 col-sm-2 no-padding">
                    <span class="title-extra-large md-title-large deep-orange-text alt-font margin-one-half no-margin-lr display-block sm-display-none">07.</span>
                  </div>
                  <div class="col-md-10 col-sm-12 no-padding">
                    <span class="text-large text-uppercase md-text-medium display-block alt-font"><a href="blog-details.html" class="light-gray-text">A Week at the Beach</a></span>
                    <span class="text-extra-small text-uppercase display-block alt-font medium-gray-text margin-one-half no-margin-lr no-margin-bottom">Posted by <a href="blog.html" class="medium-gray-text">Adrian Taylor</a></span>
                  </div>
                </div>
              </div>
    ...
    <section id="contact" class="wow fadeIn">
      <div class="container xs-text-center">
        <div class="row">
          <!-- section title -->
          <div class="col-md-12 col-sm-12 text-center">
            <span class="alt-font text-uppercase title-extra-large deep-orange-text letter-spacing-1">Contact Us</span>
        ...
        <div class="row call-us margin-thirteen no-margin-lr no-margin-bottom">
          <div class="col-md-5 col-sm-12">
            <span class="text-extra-large margin-six no-margin-lr no-margin-top display-inline-block alt-font white-text">Have a project you're interested in discussing with us? Drop us a line below, we’d love to talk.</span>
          </div>
          <div class="col-md-7 col-sm-12 text-right sm-text-left">
            <span class="title-small letter-spacing-1 white-text alt-font margin-four no-margin-lr display-block xs-text-center"><i class="icon-phone icon-small vertical-align-top xs-vertical-align-middle"></i> <a class="white-text" href="tel:+38 063 611 78 41">+38 063 611 78 41</a> &nbsp;&nbsp;<span class="xs-display-none">|</span>&nbsp;&nbsp; <a href="mailto:info@triomics.com" class="white-text xs-display-inline-block xs-margin-five xs-no-margin-lr xs-no-margin-bottm"><i class="icon-envelope icon-small vertical-align-top"></i> info@triomics.com</a></span>
          </div>
        </div>
        <div class="row">
          <!-- text -->
          <div class="col-md-5 col-sm-12 margin-nine no-margin-bottom no-margin-lr">
            <div class="sm-margin-nine sm-no-margin-tb sm-no-margin-left sm-display-inline-table xs-margin-nine xs-no-margin-lr xs-no-margin-top xs-width-100">
              <span class="text-uppercase alt-font white-text ">Our Studio</span>
              <p class="text-medium">Kyiv, Ukraine</p>
            </div>
            <div class="margin-thirteen no-margin-lr sm-margin-nine sm-no-margin-tb sm-no-margin-left sm-display-inline-table xs-margin-nine xs-no-margin-lr xs-no-margin-top xs-width-100">
              <span class="text-uppercase alt-font white-text">General Enquiries</span>
              <p class="text-medium"><a href="mailto:info@triomics.com" class="gray-text">info@triomics.com</a></p>
            </div>
            <div class="margin-six no-margin-lr sm-margin-nine sm-no-margin-tb sm-no-margin-left sm-display-inline-table xs-margin-nine xs-no-margin-lr xs-no-margin-top xs-width-100">
              <span class="text-uppercase alt-font white-text">Call us</span>
              <p class="text-medium"><a class="gray-text" href="tel:+38 066 639 39 87">+38 066 639 39 87</a></p>
            </div>
          </div>
          <!-- end text -->
    ...
    <!-- end contact section -->
    <!-- footer -->
    <footer class="wow fadeIn cover-background" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/image31.jpg');">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 col-sm-12 text-center xs-margin-nineteen xs-no-margin-lr xs-no-margin-top">
              <span class="text-uppercase alt-font text-large margin-four no-margin-lr no-margin-top display-block medium-gray-text">Can't wait to get involved,<br> <span>Connect with us now!</span></span>
            </div>
            <!-- social media link -->
            <div class="col-md-12 col-sm-12 center-col text-center">
              ...
              <a class="btn social-icon button no-letter-spacing no-margin padding-one-half no-padding-tb no-padding-left" href="https://vk.com/triomics/" target="_blank"><i class="fa fa-vk"></i></a>
            </div>
